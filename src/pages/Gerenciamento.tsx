    ...
    useEffect(() => {
        const loadData = async () => {
            try {
                ...
                console.log('[Gerenciamento] Áreas carregadas:', areas.map(a => ({ sigla: a.sigla, dominio: a.dominio, is_domain_root: a.is_domain_root })));
                setAllAreas(areas);
                ...
                console.log('[Gerenciamento] Sub-diretorias:', nonRootAreas.map(a => a.sigla));
            ...
            <div className="space-y-6">
                ...
                <div className="flex items-center justify-between gap-3">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-2xl font-bold text-slate-900">Painel de Gerenciamento</h1>
                            <p className="text-slate-600">Gerenciar permissões de acesso por diretoria</p>
                        </div>
                    </div>
                    <Button
                ...
                {diretoriasEditaveis.length > 0 ? (
                    <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                        <TabsList className={`grid w-full mb-6`} style={{ gridTemplateColumns: `repeat(${Math.min(diretoriasEditaveis.length, 7)}, 1fr)` }}>
                                            ...
                                            <div className="flex items-center justify-between">
                                                <div>
                                                    ...
                                                    <CardDescription className="mt-2">
                                                        {domainAreas.find(a => (a.sigla || a.nome) === diretoria)?.nome || DIRETORIAS_LABELS[diretoria] || diretoria}
                                                    </CardDescription>
                                                </div>
                                                <Button
