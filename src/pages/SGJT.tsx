...
export default function SGJT() {
  ...
  const carregarPermissoes = async () => {
    try {
        ...
        abas: [
          {
            codigo: "dashboard",
            nome: "Dashboard",
            descricao: "Painel inicial com visão geral",
          ...
          {
            codigo: "gestao_okrs",
            nome: "Monitoramento de OKRs",
            descricao: "Gestão Estratégica > Monitoramento de OKRs",
            icone: "Target",
            ordem: 3,
            ativo: true,
          },
          {
            codigo: "gestao_execucao",
            nome: "Escritório de Projetos",
            descricao: "Gestão Estratégica > Escritório de Projetos",
            icone: "ClipboardList",
            ordem: 4,
            ativo: true,
          },
          {
            codigo: "gestao_sprint",
            nome: "Controle de Execução",
            descricao: "Gestão Estratégica > Controle de Execução",
            icone: "RefreshCw",
            ordem: 5,
            ativo: true,
          },
          ...
          {
            codigo: "contratacoes_novas",
            nome: "Novas Contratações",
            descricao: "Contratações de TI > Novas Contratações",
            icone: "FilePlus",
            ordem: 6,
            ativo: true,
          },
          {
            codigo: "contratacoes_renovacoes",
            nome: "Renovações",
            descricao: "Contratações de TI > Renovações",
            icone: "RefreshCw",
            ordem: 7,
            ativo: true,
          },
          ...
          // Comitês
          {
            codigo: "comites",
            nome: "Comitês",
            descricao: "Gestão de comitês e reuniões",
            icone: "Megaphone",
            ordem: 8,
            ativo: true,
          },
          ...
          {
            codigo: "pessoas_painel",
            nome: "Painel",
            descricao: "Pessoas > Painel de colaboradores",
            icone: "LayoutDashboard",
            ordem: 9,
            ativo: true,
          },
          {
            codigo: "pessoas_formularios",
            nome: "Formulários",
            descricao: "Pessoas > Formulários dinâmicos",
            icone: "ClipboardList",
            ordem: 10,
            ativo: true,
          },
          ...
          {
            codigo: "cadastros_projetos",
            nome: "Projetos",
            descricao: "Cadastros > Gestão de projetos",
            icone: "FolderKanban",
            ordem: 11,
            ativo: true,
          },
          {
            codigo: "cadastros_planos",
            nome: "Planos/Programas",
            descricao: "Cadastros > Planos e programas",
            icone: "FileText",
            ordem: 12,
            ativo: true,
          },
          {
            codigo: "cadastros_areas",
            nome: "Áreas",
            descricao: "Cadastros > Gestão de áreas",
            icone: "Building2",
            ordem: 13,
            ativo: true,
          },
          {
            codigo: "cadastros_pessoas",
            nome: "Pessoas",
            descricao: "Cadastros > Cadastro de pessoas",
            icone: "Users",
            ordem: 14,
            ativo: true,
          },
      ...
      toast.warning(
        "Execute a migration 032 no banco para habilitar o gerenciamento de permissões.",
      );
    } finally {
      setLoading(false);
    }
  ...
  const handleToggleApenasPropria = (
    diretoria: Diretoria,
    abaCodigo: string,
  ) => {
    // Todas as diretorias são editáveis pelo superadmin
  ...
  const salvarPermissoes = async (diretoria: Diretoria) => {
    ...
    try {
      ...
      if (permissoes.length === 0) {
        toast.error(
          "Nenhuma permissão para salvar. Verifique se os dados foram carregados corretamente.",
        );
        return;
      }
      ...
      const resultado = await permissoesApi.atualizarPermissoesDiretoria(
        diretoria,
        permissoes,
      );
      ...
      <div className="space-y-6">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <TabsList
            ...
            style={{ gridTemplateColumns: `repeat(${DIRETORIAS.length}, 1fr)` }}
          >
            {DIRETORIAS.map((dir) => (
                                ...
                                >
                                  ...
                                  <td className="text-center py-3 px-4">
                                    <div className="flex justify-center">
                                      <Checkbox
                                        checked={
                                          perm?.apenas_propria_diretoria ?? true
                                        }
                                        onCheckedChange={() =>
