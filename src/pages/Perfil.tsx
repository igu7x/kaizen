...
import { Loader2, Camera, UserCircle2, Lock, Save, AlertCircle } from 'lucide-react';
...
export default function Perfil() {
  ...
  const unidadeLabel = profile?.unidade_nome || 'Não vinculado a nenhuma unidade';
        ...
        {loading ? (
          ...
          <Card className="border border-amber-200 bg-amber-50">
            <CardContent className="p-6 flex items-start gap-3">
              ...
              <div>
                <p className="font-medium text-amber-800">Não foi possível carregar seu perfil</p>
          ...
          <div className="space-y-6">
                ...
                <div className="flex items-center gap-6">
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      A imagem será redimensionada automaticamente para até 1024×1024 px.
                    </p>
                  </div>
                </div>
              </CardContent>
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input value={profile.name || ''} disabled className="bg-gray-50 mt-1" />
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <Input value={profile.diretoria || '—'} disabled className="bg-gray-50 mt-1" />
                  </div>
                  <div>
                ...
                <p className="text-xs text-gray-500">
                  Nome, e-mail, diretoria e unidade são gerenciados pelo administrador. Para alterações, entre em contato com a equipe responsável.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <p className="text-xs text-gray-500">
                  Esses dados vêm do cadastro central e não podem ser alterados aqui.
                </p>
              </CardContent>
            </Card>
            ...
            {(() => {
              const dirtyFoto = (fotoPerfil || null) !== (profile.foto_perfil || null);
