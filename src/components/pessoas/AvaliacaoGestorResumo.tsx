...
interface AvaliacaoGestorResumoProps {
  ...
  onValidated?: (formulario: AvaliacaoGestorFormulario) => void;
  onEdit?: (formulario: AvaliacaoGestorFormulario) => void;
    ...
    <div className="space-y-6 max-w-4xl mx-auto">
      ...
      <Card className="border border-gray-200 shadow-sm">
        <CardHeader className="pb-3">
          <CardTitle className="text-lg">Colaborador Avaliado</CardTitle>
        </CardHeader>
        <CardContent>
