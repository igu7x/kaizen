...
export const ModalGestor: React.FC<ModalGestorProps> = ({
  isOpen,
  onClose,
  onSuccess,
  gestorEditar,
  ...
  const fetchPossiveisPais = useCallback(
    async (
      linha: number,
      diretoriaFiltro?: string,
    ): Promise<PossiveliPai[]> => {
      if (linha <= 1) {
        setPossiveisPais([]);
        return [];
      }
    ...
    const carregarDadosEdicao = async () => {
      ...
      if (gestorEditar) {
        ...
        if (gestorEditar.foto_gestor) {
          ...
          if (
            gestorEditar.foto_gestor.startsWith("http") ||
            gestorEditar.foto_gestor.startsWith("data:")
          ) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      formDataToSend.append(
        "linha_organograma",
        formData.linha_organograma.toString(),
      );
      ...
      if (formData.subordinacao_id) {
        formDataToSend.append(
          "subordinacao_id",
          formData.subordinacao_id.toString(),
        );
      }
  ...
  const paisValidos = possiveisPais.filter(
    (pai) => pai.nome_gestor && pai.nome_gestor.trim() !== "",
  );
  ...
  const selectValue =
    formData.subordinacao_id && itemExiste
      ? formData.subordinacao_id.toString()
      : undefined;
      ...
      >
        ...
        >
          ...
          <div className="space-y-4">
            <h3 className="font-semibold text-gray-900 border-b-2 border-gray-200 pb-2">
              Informações da Área
            </h3>
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  setFormData({ ...formData, nome_area: e.target.value })
                }
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  setFormData({ ...formData, nome_exibicao: e.target.value })
                }
                placeholder="Ex: CODESG (será exibido no card do organograma)"
              />
              <p className="text-xs text-gray-500 mt-1">
                Se preenchido, este nome será exibido no card do organograma em
                vez do nome completo da área.
              </p>
            </div>

            <div className="grid grid-cols-2 gap-4">
              <div>
                <Label htmlFor="linha_organograma">
                  Linha do Organograma *
                </Label>
                <Select
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    setFormData({
                      ...formData,
                      subordinacao_id: parseInt(value),
                    })
                  }
                ...
                >
                  ...
                  >
                    ...
                    {formData.linha_organograma === 1 ? (
                      ...
                      <span>
                        {paiAtual.nome_gestor} ({paiAtual.nome_area})
                      </span>
                    ) : (
                      <span className="text-muted-foreground">
              ...
              <>
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setFormData({ ...formData, nome_cargo: e.target.value })
                    }
