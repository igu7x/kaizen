...
export const createResponse = async (
  data: Omit<FormResponse, "id" | "createdAt" | "updatedAt"> & {
    answers?: FormAnswer[];
  },
): Promise<FormResponse> => {
  const { answers, ...responseData } = data as FormResponse & {
    answers?: FormAnswer[];
  };

  return apiClient.post<FormResponse>(
    `/api/forms/${responseData.formId}/responses`,
    {
...
export const updateResponse = async (
  ...
  console.warn(
    "updateResponse: Use createResponse com status DRAFT para atualizar",
  );
