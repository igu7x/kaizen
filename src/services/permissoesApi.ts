...
export const DIRETORIAS: string[] = [
  "SGJT",
  "DPE",
  "DIJUD",
  "DITI",
 ...
 */
export const getPermissoesUsuario = async (
  usuarioId: number,
): Promise<PermissaoUsuario[]> => {
  return apiClient.get<PermissaoUsuario[]>(
    `/api/permissoes/usuario/${usuarioId}`,
  );
};
 ...
 */
export const getPermissoesDiretoria = async (
  diretoria: Diretoria,
): Promise<PermissaoDiretoria[]> => {
  return apiClient.get<PermissaoDiretoria[]>(
    `/api/permissoes/diretoria/${diretoria}`,
  );
};
 ...
 */
export const getModulosPermitidosMenu = async (
  diretoria: Diretoria,
): Promise<{
  diretoria: Diretoria;
...
export const getTodasPermissoes = async (): Promise<TodasPermissoes> => {
  ...
  try {
    return await apiClient.get<TodasPermissoes>("/api/permissoes/todas", {
      headers,
    });
  } catch (error: any) {
    console.warn(
      "Erro ao buscar permissões (tabelas podem não existir):",
      error.message,
    );
    throw error;
  }
...
export const atualizarPermissao = async (
  ...
  return apiClient.put(
    `/api/permissoes/diretoria/${diretoria}/aba/${abaCodigo}`,
    {
 ...
 */
export const getModulosNaoAdicionados = async (): Promise<
...
export const adicionarModulosExistentes = async (
  ...
  return apiClient.post(
    "/api/permissoes/adicionar-modulos",
    {
      codigos,
    },
    { headers },
