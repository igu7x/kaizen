...
export const comitesApi = {
     ...
     * Criar novo comitê
     */
    async create(data: { nome: string; sigla: string; descricao?: string; icone?: string; cor?: string; dominio?: string }): Promise<Comite> {
        return apiClient.post<Comite>('/api/comites', data, { headers: getUserHeaders() });
    },
