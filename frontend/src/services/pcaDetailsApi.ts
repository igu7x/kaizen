 ...
 */
export async function getPcaItemAllDetails(
  pcaItemId: number,
): Promise<PcaItemAllDetails> {
  return apiClient.get<PcaItemAllDetails>(
    `/api/pca-items/${pcaItemId}/all-details`,
    {
 ...
 */
export async function getPcaItemDetails(
  pcaItemId: number,
): Promise<PcaItemDetails> {
 ...
 */
export async function updatePcaItemDetails(
  pcaItemId: number,
  data: UpdatePcaDetailsDto,
): Promise<PcaItemDetails> {
  return apiClient.put<PcaItemDetails>(
    `/api/pca-items/${pcaItemId}/details`,
    data,
    {
      headers: getUserHeaders(),
    },
 ...
 */
export async function getPcaChecklist(
  pcaItemId: number,
): Promise<PcaChecklistResponse> {
  return apiClient.get<PcaChecklistResponse>(
    `/api/pca-items/${pcaItemId}/checklist`,
    {
      headers: getUserHeaders(),
    },
  );
 ...
 */
export async function getPontosControle(
  pcaItemId: number,
): Promise<PcaPontoControle[]> {
  return apiClient.get<PcaPontoControle[]>(
    `/api/pca-items/${pcaItemId}/pontos-controle`,
    {
      headers: getUserHeaders(),
    },
  );
 ...
 */
export async function createPontoControle(
  pcaItemId: number,
  data: CreatePontoControleDto,
): Promise<PcaPontoControle> {
  return apiClient.post<PcaPontoControle>(
    `/api/pca-items/${pcaItemId}/pontos-controle`,
    data,
    {
      headers: getUserHeaders(),
...
export async function updatePontoControle(
  ...
  return apiClient.put<PcaPontoControle>(
    `/api/pca-items/${pcaItemId}/pontos-controle/${pontoId}`,
    data,
    {
      headers: getUserHeaders(),
    },
 ...
 */
export async function getPontosControleComTarefas(
  pcaItemId: number,
): Promise<import("@/types").PcaPontoControleComTarefas[]> {
...
export async function createTarefa(
  ...
  return apiClient.post<PcaTarefa>(
    `/api/pca-items/${pcaItemId}/tarefas`,
    data,
    {
      headers: getUserHeaders(),
    },
...
export async function updateTarefa(
  ...
  return apiClient.put<PcaTarefa>(
    `/api/pca-items/${pcaItemId}/tarefas/${tarefaId}`,
    data,
    {
      headers: getUserHeaders(),
    },
...
export async function updateTarefaStatus(
  ...
  return apiClient.patch<PcaTarefa>(
    `/api/pca-items/${pcaItemId}/tarefas/${tarefaId}/status`,
    { status },
    {
      headers: getUserHeaders(),
    },
...
export async function saveAllChanges(
  pcaItemId: number,
  changes: SaveAllChangesRequest,
): Promise<SaveAllChangesResponse> {
  return apiClient.patch<SaveAllChangesResponse>(
    `/api/pca-items/${pcaItemId}/save-all-changes`,
    changes,
    {
      headers: getUserHeaders(),
    },
