...
export async function getUsers(dominio?: string): Promise<User[]> {
    const url = dominio ? `/api/users?dominio=${encodeURIComponent(dominio)}` : '/api/users';
...
export async function getObjectives(directorate?: string): Promise<Objective[]> {
    const params = directorate ? `?directorate=${encodeURIComponent(directorate)}` : '';
...
export async function getKeyResults(directorate?: string): Promise<KeyResult[]> {
    const params = directorate ? `?directorate=${encodeURIComponent(directorate)}` : '';
...
export async function getInitiatives(directorate?: string): Promise<Initiative[]> {
    const params = directorate ? `?directorate=${encodeURIComponent(directorate)}` : '';
...
export async function updateDirectorateProadLink(code: Directorate, proadLink: string | null): Promise<DirectorateInfo> {
    return apiClient.put<DirectorateInfo>(`/api/directorates/${code}`, { proadLink });
}
...
export async function getExecutionControls(directorate?: string): Promise<ExecutionControl[]> {
    const params = directorate ? `?directorate=${encodeURIComponent(directorate)}` : '';
...
export async function updateExecutionControlOrdenacao(ordenacao: { id: number; linha: number; posicao: number }[]): Promise<void> {
