        ...
        <div className="flex gap-4">
          ...
          <div className="text-base text-gray-700 space-y-4">
            <p>
              ...
              formulário tem como objetivo mapear as competências necessárias
              que o gestor da unidade/núcleo deve possuir para gerir sua área e
              liderar sua equipe de forma eficaz.
            </p>
            <p>
              Registre as competências que julga essenciais para o desempenho da
              função de liderança da unidade em questão.
            </p>
        ...
        <div className="flex gap-4">
          ...
          <div className="text-base text-gray-700 space-y-4">
            ...
            <p>
              ...
              que o gestor da unidade deve possuir. Essas competências devem
              refletir os conhecimentos, habilidades e atitudes fundamentais
              para que o gestor consiga conduzir a área e liderar a equipe de
              forma eficaz.
            </p>
