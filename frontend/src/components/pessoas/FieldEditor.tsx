          ...
          <div className="space-y-4 pt-3 border-t">
            ...
            {needsOptions && (
              <div className="space-y-3">
                ...
                <p className="text-sm text-gray-600">
                  Configure as opções que o usuário poderá selecionar:
                </p>
                ...
                {(field.config?.options || []).length === 0 && (
                  <p className="text-sm text-amber-600">
                    ⚠️ Adicione pelo menos uma opção para este campo funcionar
                  </p>
                )}
              </div>
            )}
            ...
            {needsScale && (
              <div className="space-y-3">
                ...
                <p className="text-sm text-gray-600">
                  Defina os valores e rótulos da escala numérica:
                </p>
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div>
                    <Label htmlFor={`minlabel-${field.id}`}>
                  ...
                  <div>
                    <Label htmlFor={`maxlabel-${field.id}`}>
            ...
            <div className="flex items-center justify-between pt-3 border-t">
              <div>
                <Label htmlFor={`required-${field.id}`} className="text-base">
                  Campo obrigatório
                </Label>
                <p className="text-sm text-gray-600">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex gap-2">
                        {Array.from(
                          {
                            length:
                              (field.config?.maxValue || 5) -
                              (field.config?.minValue || 1) +
                              1,
                          },
                          (_, i) => (field.config?.minValue || 1) + i,
                        ).map((num) => (
